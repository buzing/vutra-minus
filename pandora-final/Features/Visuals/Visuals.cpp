...
void Visuals::RenderHealth(const Box_t& box, C_CSPlayer* entity) {
	...
	g_Vars.visuals_enemy.health_color_override
		? Render::Engine::RectFilled(box.x - 5, box.y + (box.h - bar_size), 2, bar_size, DetermineVisualsColor(visuals_config->health_color.ToRegularColor().OverrideAlpha(210, true), entity)) :
